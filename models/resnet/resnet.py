...
#** one single network for both s and t
class ResNet(nn.Module):
    ...
    def __init__(self, in_channels, mid_channels, out_channels,
        ...
        self.in_norm = nn.BatchNorm2d(in_channels) #* remeber there is a batchnorm layer and weight normalization for s and t
        self.double_after_norm = double_after_norm #* double after norm is a weird one, why is this done?
